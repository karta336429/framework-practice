...
<body>
	...
	<div>
		...
		<ul>
			<li><a
				href='${pageContext.request.contextPath}/emp/emp.do?action=listAll'>List</a>
				all Emps.</li>
			<br>
			...
			<li>
				<form method="POST"
					action="${pageContext.request.contextPath}/dept/dept.do">
	...
	<div>
		...
		<ul>
			<li><a
				href='${pageContext.request.contextPath}/emp/emp.do?action=add'>Add</a>
				a new Emp.</li>
		</ul>
	</div>
	<div>
		...
		<ul>
			<li><a
				href='${pageContext.request.contextPath}/dept/dept.do?action=listAll'>List</a>
				all Depts.</li>
		</ul>
	</div>
</body>
